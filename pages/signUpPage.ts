...
export class SignUpPage {
  ...
  async fillInAccountDetails(firstName: string, lastName: string) {
    ...
    await this.page.locator('select[data-qa="days"]').selectOption(user.dateofBirth.day.toString());
    await this.page.locator('select[data-qa="months"]').selectOption(user.dateofBirth.month.toString());
    await this.page.locator('select[data-qa="years"]').selectOption(user.dateofBirth.year.toString());
